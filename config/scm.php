...
return [
    'po_cc_recipients' => array_values(array_filter(array_map('trim', explode(',', (string) env(
        'PO_CC_RECIPIENTS',
        'lateef.olanrewaju@emeraldcfze.com,bunmi.babajide@emeraldcfze.com,procurement@emeraldcfze.com'
    ))))),
    ...
    // Invoice submission CC printed on the Emerald PO (always includes procurement).
    'invoice_submission_cc' => env(
        'PO_INVOICE_SUBMISSION_CC',
