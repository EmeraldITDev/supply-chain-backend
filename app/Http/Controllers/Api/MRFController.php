   ...
   protected function generateFreshPOUrls(MRF $mrf): array
    ...
    public function show(Request $request, $id)
    {
        ...
        return response()->json(array_merge(
            ...
            'po_number' => $mrf->effectivePoNumber(),
            'poNumber' => $mrf->effectivePoNumber(),
            'linked_po_id' => $mrf->linked_po_id,
            'linkedPoId' => $mrf->linked_po_id,
    ...
    public function store(Request $request)
    {
        ...
        if (!$isPrivilegedAuthor && !$isDepartmentEmployee && !$isExecutive) {
            return response()->json([
                ...
                'error' => 'Only designated staff, logistics managers, procurement managers, or admins can create Material Request Forms.',
            ], 403);
        }
