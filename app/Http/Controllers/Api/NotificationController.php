...
class NotificationController extends Controller
{
    ...
    private function titleFromType(string $type): string
    {
        return match ($type) {
            ...
            'trip_request_director_approved' => 'Trip Request Approved',
            'trip_request_director_rejected' => 'Trip Request Rejected',
            'trip_request_returned' => 'Trip Request Returned',
            'trip_request_director_review' => 'Trip Awaiting Director Approval',
