    ...
    public function index(Request $request, string $id)
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'delivered_at' => $mrf->grn_completed_at?->toIso8601String(),
                'deliveredAt' => $mrf->grn_completed_at?->toIso8601String(),
                'goods_received_at' => $mrf->grn_completed_at?->toIso8601String(),
                'goodsReceivedAt' => $mrf->grn_completed_at?->toIso8601String(),
                'grn_completed_at' => $mrf->grn_completed_at?->toIso8601String(),
                'grnCompletedAt' => $mrf->grn_completed_at?->toIso8601String(),
                'po_created_at' => $mrf->po_generated_at?->toIso8601String(),
                'poCreatedAt' => $mrf->po_generated_at?->toIso8601String(),
                'po_value' => $mrf->po_value !== null ? (float) $mrf->po_value : null,
